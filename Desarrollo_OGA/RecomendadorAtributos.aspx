...
<%@ Register Tagprefix="SharePoint" Namespace="Microsoft.SharePoint.WebControls"
    ...
    <%@ Register Tagprefix="SharePoint" Namespace="Microsoft.SharePoint.WebControls"
        ...
        <head>
            <meta charset="UTF-8">
            <title>Recomendador de Atributos</title>
            ...
            <style>
                .top-aportes {
                    ...
                    /* Cambiar para ocultar hacia arriba */
                ...
                .top-aportes .top-aportes-button {
                    position: absolute !important;
                    top: 100%;
                    /* Se posiciona justo debajo del contenedor */
                    left: 50%;
                    background: #fff;
                    padding: 7px 13px;
                    border-radius: .2rem;
                ...
                .icon-container {
                    height: auto;
                    /* Por defecto, la altura se ajusta automáticamente */
                    display: flex;
                    /* Distribuye los íconos en una fila */
                    flex-wrap: wrap;
                    /* Permite que los íconos se envuelvan si no hay suficiente espacio */
                    padding-left: 10px;
                }
                ...
                #tbl_entidades_pendientes tbody td {
                    padding: 2px 0;
                    /* Ajustar el padding para mayor control */
        ...
        <body id="app-container" class="menu-default show-spinner">
            ...
            <main>
                <div class="container-fluid">
                    <div class="row pb-2">
                        <div class="col-12">
                            <h1>Recomendador de Atributos</h1>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                            ...
                                            <table id="tbl_recomendador_atributos" class="table">
                                                <thead>
                                                    <tr>
                                                        <th>Acciones</th>
                                                        <th>Servidor</th>
