...
<head>
    ...
    <style>
        @keyframes parpadeo {
            0%, 100% {
                box-shadow: 0 0 2px rgba(210, 0, 110, 0.6), 0 0 12px rgba(210, 0, 110, 0.4);
            }
            50% {
                box-shadow: 0 0 5px rgba(210, 0, 110, 1), 0 0 15px rgba(210, 0, 110, 0.8);
            }
        }
        .top-aportes {
                ...
                <div class="col-12">
                    <div class="card card-datatable">
                        <div class="top-aportes">
                            ...
                            <a href="#" class="top-aportes-button animacion-parpadeo" data-toggle="tooltip" data-placement="bottom" title="Top Aportes"> <i class="simple-icon-trophy text-primary"></i> </a>
                        </div>
                        <div class="card-body" >
