...
<mso:_CopySource msdt:dt="string">http://vamos.bancoguayaquil.com/sitios/informaciongerencial/OGAsuite_Produccion/Produccion/Ficha_Atributo_test_M.aspx</mso:_CopySource>
<mso:Order msdt:dt="string">226100.000000000</mso:Order>
...
<body id="app-container" class="menu-default show-spinner">
    ...
    <script>
        var n = new Date().getTime();
        document.write('<script src="js/suite_test_M.js?v='+n+'"> <'+'/'+'script>');
    </script>
    <script>
