...
<mso:_SharedFileIndex msdt:dt="string"></mso:_SharedFileIndex>
        ...
        <body id="app-container" class="menu-default show-spinner">
            ...
            <main>
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-1">
                                <h1 class="mb-1">Visor de Reportes</h1>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="card" style="margin-top:0">
                                <div class="card-body" id="visor-wrapper">
                                    <div id="visor-mensaje" class="text-muted text-center">
                                        Cargando archivo...
                                    </div>
                                </div>
                            </div>
            ...
            <script>
                // Visor dinámico para PDF en ./reportes/ usando ?archivo= o ?file=
                (function () {
                    var params = new URLSearchParams(window.location.search);
                    var raw = params.get("archivo") || params.get("file") || "";
                    var mensaje = document.getElementById("visor-mensaje");
                    var wrapper = document.getElementById("visor-wrapper");

                    if (!mensaje || !wrapper) return;

                    if (!raw) {
                        mensaje.textContent = "Falta el parametro ?archivo=nombre.pdf";
                        return;
                    }

                    var sanitized = raw.replace(/[^a-zA-Z0-9._-]/g, "");
                    var esPdf = sanitized.toLowerCase().endsWith(".pdf");
                    if (sanitized !== raw || !esPdf) {
                        mensaje.textContent = "Nombre de archivo no valido.";
                        return;
                    }

                    var url = "reportes/" + encodeURIComponent(sanitized);
                    var object = document.createElement("object");
                    object.setAttribute("type", "application/pdf");
                    object.setAttribute("data", url + "#zoom=90");
                    object.setAttribute("width", "100%");
                    object.setAttribute("height", "900px");
                    object.id = "visor-pdf";
