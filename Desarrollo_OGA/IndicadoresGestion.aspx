...
<mso:_CopySource msdt:dt="string">http://vamos.bancoguayaquil.com/sitios/informaciongerencial/OGAsuite_Produccion/Produccion/IndicadoresGestion.aspx</mso:_CopySource>
<mso:Order msdt:dt="string">220900.000000000</mso:Order>
...
<body id="app-container" class="menu-default show-spinner">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body p-3">
                        <iframe id="reportingIndicadoresGestion" frameborder="0" width="100%" height="450px" src="http://vamos.bancoguayaquil.com/sitios/informaciongerencial/_layouts/15/ReportServer/RSViewerPage.aspx?rv:RelativeReportUrl=/sitios/informaciongerencial/Reports/OGA/INDICADORES_GESTION.rdl"></iframe>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $( document ).ready(function(){IndicadoresGestion()});
    </script>
</body>
