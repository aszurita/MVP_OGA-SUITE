...
<head>
    <meta charset="UTF-8">
    <title>Orí­genes de datos</title>
...
<mso:_CopySource msdt:dt="string">http://vamos.bancoguayaquil.com/sitios/informaciongerencial/OGAsuite_Produccion/Produccion/Origenes_datos.aspx</mso:_CopySource>
<mso:Order msdt:dt="string">208400.000000000</mso:Order>
    ...
    <main>
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="mb-2">
                        <h1>Orí­genes de datos</h1>
                        <div class="separator mb-1"></div>
                    </div>
                </div>
            </div>
            <div class="row mt-2" id="servidores">
            </div>
            <nav class="mt-4 mb-4">
