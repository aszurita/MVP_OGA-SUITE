...
<mso:_CopySource msdt:dt="string">http://vamos.bancoguayaquil.com/sitios/informaciongerencial/OGAsuite_Produccion/Produccion/DataIndex.aspx</mso:_CopySource>
<mso:Order msdt:dt="string">227300.000000000</mso:Order>
...
<body id="app-container" class="menu-default show-spinner">
                ...
                <div class="col-12 p-0">
                    <div class="card">
                        <div class="card-body p-2"><!--541.25-->
                            <i data-toggle="modal" onclick="reloadframes()"  data-target="#DataIndex" class="iconsminds-full-screen-2 float-right" style="font-size: 18px;cursor: pointer;"></i>
                            <iframe class="estrategia" title="analisis_similitud" width="100%" height="393" src="https://app.powerbi.com/reportEmbed?reportId=65827035-0efa-4a65-8274-d0bdb013aa37&autoAuth=true&ctid=78181095-efa1-4806-9626-ca6be188d1d0" frameborder="0" allowFullScreen="true"></iframe>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!--Ventana Modal-->
    <div class="modal fade pl-1 pr-1" id="DataIndex" tabindex="-1" role="dialog" aria-labelledby="DataIndex" aria-hidden="true">
        <div class="modal-dialog modal-xl h-100" role="document" style="min-width:95%;">
          <div class="modal-content h-100">
            ...
            <div class="modal-body p-0">
                <iframe title="analisis_similitud" width="100%" height="100%" src="https://app.powerbi.com/reportEmbed?reportId=65827035-0efa-4a65-8274-d0bdb013aa37&autoAuth=true&ctid=78181095-efa1-4806-9626-ca6be188d1d0" frameborder="0" allowFullScreen="true"></iframe>
            </div>
          </div>
        </div>
      </div>
