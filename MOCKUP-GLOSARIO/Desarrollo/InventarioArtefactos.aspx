...
<head>
    <meta charset="UTF-8">
    <title>Inventario de Artefactos</title>
...
<body id="app-container" class="menu-default show-spinner">
    ...
    <main>
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="mb-2">
                        <h1>Inventario de Artefactos</h1>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body p-3">
                        <iframe class="estrategia" width="100%" height="393" src="http://vamos.bancoguayaquil.com/sitios/informaciongerencial/Reports/OGA/Artefactos_dominio_solo_vista.rdl?Web=1" frameborder="0" allowFullScreen="true"></iframe>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $( document ).ready(function(){InventarioArtefactos()});
    </script>
</body>
