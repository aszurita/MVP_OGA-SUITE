...
<head>
    <meta charset="UTF-8">
    <title>Fuentes de Aprovisionamiento</title>
...
<mso:_CopySource msdt:dt="string">http://vamos.bancoguayaquil.com/sitios/informaciongerencial/OGAsuite_Produccion/Produccion/FuentesAprovisionamiento.aspx</mso:_CopySource>
<mso:Order msdt:dt="string">172600.000000000</mso:Order>
...
<body id="app-container" class="menu-default show-spinner">
    ...
    <main>
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h1>Fuentes de Aprovisionamiento</h1>
                    <div class="mb-2">
                        <div class="collapse d-md-block" id="displayOptions">
                            <div class="d-block d-md-inline-block" style="width: 100%;">
                                <div class="search-sm float-md-left mr-1 mb-1 align-top" style="width:30.6%; display:flex;">
                                    <input placeholder="Buscar..." id="fuentes-search" style="width: 100%;" autocomplete="off">
                                    <i class="iconsminds-magnifi-glass" id="fuentes-lupa"> </i>
                                </div>
            ...
            <div class="row pl-3">
                <div class="col-12">
                    <div class=" d-flex flex-row flex-wrap" id="fuentes">
                    </div>
                    <nav class="mt-4 mb-4">
